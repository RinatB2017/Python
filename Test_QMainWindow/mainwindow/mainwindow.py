...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_run_dialog = QtWidgets.QPushButton(self.centralwidget)
        self.btn_run_dialog.setObjectName("btn_run_dialog")
        self.horizontalLayout_2.addWidget(self.btn_run_dialog)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem)
        self.btn_0 = QtWidgets.QToolButton(self.centralwidget)
        self.btn_0.setObjectName("btn_0")
        self.horizontalLayout_2.addWidget(self.btn_0)
        self.btn_1 = QtWidgets.QToolButton(self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_run_dialog.setText(_translate("MainWindow", "Run dialog"))
